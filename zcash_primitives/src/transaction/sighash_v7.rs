...
use crate::transaction::{
    ...
    txid::{
        ZCASH_V7_VP_DELTAS_HASH_PERSONALIZATION, hash_v7_effects_bundles, hasher,
        tx_hash_personalization, v7_bundle_digest_entries,
    },
};

/// Computes the v7 signature digest.
...
>(
    ...
    let signature_bundles_digest = hash_v7_effects_bundles(v7_bundle_digest_entries(
        tx.transparent_bundle()
            .is_some()
