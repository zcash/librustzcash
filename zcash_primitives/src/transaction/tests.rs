...
fn tachyon_v6_test_vectors() {
    ...
    const EXPECTED_RK_42: [u8; 32] = [
        0xba, 0x64, 0x54, 0xc4, 0xa1, 0xd4, 0x27, 0x30, 0xb5, 0x3c, 0xbf, 0x30, 0xd0, 0x5d,
        0x3f, 0x95, 0xaa, 0x54, 0x1c, 0x98, 0xeb, 0xa0, 0x20, 0x5a, 0x75, 0xbb, 0x79, 0x83,
        0x44, 0x3b, 0x37, 0x31,
    ];
    // Expected rk bytes for rk_from_seed([0x43; 64]).
    const EXPECTED_RK_43: [u8; 32] = [
        0x33, 0x6a, 0x1f, 0x7e, 0xd0, 0x90, 0x31, 0x93, 0xf3, 0x9f, 0xa5, 0x30, 0x6f, 0x3f,
        0xd8, 0x8d, 0x8a, 0x0a, 0x89, 0x07, 0xa1, 0xde, 0xfd, 0xe5, 0x47, 0xf1, 0x17, 0xe7,
        0x07, 0x5d, 0x9e, 0x01,
    ];
