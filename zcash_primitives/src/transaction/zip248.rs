...
impl Clone for TypedBundle<Authorized> {
    fn clone(&self) -> Self {
        match self {
            Self::Transparent(arg0) => Self::Transparent(arg0.clone()),
            Self::Sprout(arg0) => Self::Sprout(arg0.clone()),
            Self::Sapling(arg0) => Self::Sapling(arg0.clone()),
            Self::Orchard(arg0) => Self::Orchard(arg0.clone()),
            #[cfg(zcash_unstable = "zfuture")]
            Self::Tze(arg0) => Self::Tze(arg0.clone()),
...
impl Clone for BundleMap<Authorized> {
    fn clone(&self) -> Self {
        Self {
...
mod tests {
    ...
    fn value_pool_deltas_basic() {
        ...
        assert_eq!(
            types,
            vec![BUNDLE_TYPE_SAPLING, BUNDLE_TYPE_FEE, BUNDLE_TYPE_ZIP233_NSM,]
        );
    }
