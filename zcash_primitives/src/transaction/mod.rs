...
impl<A: Authorization> TransactionData<A> {
    ...
    pub fn from_parts(
        ...
        #[cfg(feature = "zip-233")] zip233_amount: Option<NonNegativeAmount>,
    ) -> Self {
        TransactionData {
            version,
            consensus_branch_id,
    ...
    pub fn digest<D: TransactionDigest<A>>(&self, digester: D) -> D::Digest {
        digester.combine(
            ...
            #[cfg(feature = "zip-233")]
            digester.digest_zip233_amount(self.zip233_amount.as_ref()),
            #[cfg(zcash_unstable = "zfuture")]
    ...
    pub fn map_bundles<B: Authorization>(
        ...
        TransactionData {
            ...
            #[cfg(feature = "zip-233")]
            burn_amount: self.zip233_amount,
            #[cfg(zcash_unstable = "zfuture")]
...
impl Transaction {
    fn from_data(data: TransactionData<Authorized>) -> io::Result<Self> {
        match data.version {
            ...
            #[cfg(zcash_unstable = "nu7")]
            TxVersion::V6 => Ok(Self::from_data_v5(data)),
            #[cfg(zcash_unstable = "zfuture")]
...
pub struct TxDigests<A> {
    ...
    #[cfg(feature = "zip-233")]
    pub zip233_amount_digest: Option<A>,
    #[cfg(zcash_unstable = "zfuture")]
...
pub trait TransactionDigest<A: Authorization> {
    ...
    #[cfg(feature = "zip-233")]
    fn digest_zip233_amount(&self, zip233_amount: Option<&NonNegativeAmount>) -> Self::Zip233AmountDigest;
    ...
    fn combine(
        ...
        #[cfg(feature = "zip-233")] zip233_amount_digest: Self::Zip233AmountDigest,
...
pub mod testing {
    ...
    #[cfg(all(not(feature = "zip-233", zcash_unstable = "zfuture"))]
    prop_compose! {
        pub fn arb_txdata(consensus_branch_id: BranchId)(
            version in arb_tx_version(consensus_branch_id),
        )(
    ...
    #[cfg(all(feature = "zip-233", zcash_unstable = "zfuture"))]
    prop_compose! {
        pub fn arb_txdata(consensus_branch_id: BranchId)(
            version in arb_tx_version(consensus_branch_id),
        )(
