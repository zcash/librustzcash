...
impl<'a, P: consensus::Parameters, U: sapling::builder::ProverProgress> Builder<'a, P, U> {
    ...
    fn build_internal<R: RngCore + CryptoRng, SP: SpendProver, OP: OutputProver, FE>(
        ...
        #[cfg(zcash_unstable = "nu6")] /* TODO nu7 */ let mut unproven_orchard_zsa_bundle: Option<
            orchard::Bundle<
        ...
        #[cfg(zcash_unstable = "nu6")] /* TODO nu7 */ let orchard_zsa_bundle = unauthed_tx
            .orchard_zsa_bundle
            .map(|b| {
                b.create_proof(
        ...
        #[cfg(zcash_unstable = "nu6")] /* TODO nu7 */ let issue_bundle = unauthed_tx
            .issue_bundle
