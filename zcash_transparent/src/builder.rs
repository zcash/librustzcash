...
impl TransparentBuilder {
    ...
    pub fn add_input(
        ...
        let script_pubkey = script::PubKey::parse(&script::Code(&coin.script_pubkey().0))
    ...
    pub fn build_for_pczt(self) -> Option<pczt::Bundle> {
        ...
        let inputs = self
            ...
            .map(|i| pczt::Input {
                ...
                script_sig: None,
                value: i.coin.value(),
                script_pubkey: script::PubKey::parse(&script::Code(&i.coin.script_pubkey().0))
        ...
        if inputs.is_empty() && self.vout.is_empty() {
            ...
            let outputs = self
                ...
                .map(|o| pczt::Output {
                    value: o.value(),
                    script_pubkey: script::PubKey::parse(&script::Code(&o.script_pubkey().0))
