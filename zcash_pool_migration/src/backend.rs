...
//! self-payment migration transfer at the wallet's natural (witnessable) anchor, and driving the
...
/// the wallet's natural (witnessable) `anchor_height` and emit one Ironwood (version-6) output
