...
mod tests {
    ...
    #[test]
    fn prefer_fewest_accounts_for_selected_transparent_value() {
        zcash_client_backend::data_api::testing::transparent::prefer_fewest_accounts_for_selected_transparent_value(
            TestDbFactory::default(),
            BlockCache::new(),
        );
    }
