...
CREATE INDEX idx_sapling_received_note_address ON sapling_received_notes (
    address_id ASC
)"#;
...
CREATE INDEX idx_orchard_received_note_address ON orchard_received_notes (
    address_id ASC
)"#;
...
CREATE INDEX idx_transparent_received_outputs_account_id ON transparent_received_outputs (
    account_id
)"#;
pub(super) const INDEX_TRANSPARENT_RECEIVED_OUTPUTS_TX: &str = r#"
CREATE INDEX idx_transparent_received_outputs_transaction_id ON transparent_received_outputs (
    transaction_id
)"#;
