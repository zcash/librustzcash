//! A migration that brings transparent UTXO handling into line with that for shielded
...
impl schemerz::Migration<Uuid> for Migration {
    ...
    fn description(&self) -> &'static str {
        "Updates transparent UTXO handling to be similar to that for shielded notes, and adds spent_note_count and is_shielding to v_transactions."
    }
}
