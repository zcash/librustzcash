...
pub const MIGRATION_ID: Uuid = Uuid::from_u128(0xc9c8eb79_846a_4403_b400_d7bc263765b9);

/// `v_tx_outputs_transparent_addresses` is the prior owner of the `v_tx_outputs` definition
/// this migration recreates.
pub(super) const DEPENDENCIES: &[Uuid] = &[v_tx_outputs_transparent_addresses::MIGRATION_ID];
