...
use crate::{get_db_paths, remote::connect_to_lightwalletd, DEFAULT_WALLET_DIR, KEYS_FILE};
...
impl Command {
    pub(crate) fn run(
        ...
        let birthday = futures::executor::block_on(
            client
        ...
        let db_cache = BlockDb::for_path(db_cache)?;
