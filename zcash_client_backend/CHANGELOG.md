...
- `zcash_client_backend::data_api`:
  ...
  - The following methods have had their default implementations replaced by
    invocations of the `unimplemented!()` macro, so that applications that
    inadvertently use these default impls will panic instead of returning
    incorrect results.
    ...
    - `WalletRead::get_transparent_address_metadata`
    - `WalletRead::get_known_ephemeral_addresses`
    - `WalletRead::find_account_for_ephemeral_address`
- `zcash_client_backend::fees`:
