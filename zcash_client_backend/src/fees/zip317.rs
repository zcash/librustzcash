...
mod tests {
    ...
    fn change_without_dust_multi() {
...

        {
            ...
            // FIXME: The current splitting strategy may result in overpaying fees by a small amount.
            // This may be acceptable for an initial implementation.
            //assert_matches!(
            //    result,
            //    Ok(balance) if
            //        balance.proposed_change() == [
            //            ChangeValue::sapling(NonNegativeAmount::const_from_u64(124_3750), None),
            //            ChangeValue::sapling(NonNegativeAmount::const_from_u64(124_3750), None),
            //            ChangeValue::sapling(NonNegativeAmount::const_from_u64(124_3750), None),
            //            ChangeValue::sapling(NonNegativeAmount::const_from_u64(124_3750), None),
            //        ] &&
