...
impl Service<Uri> for HttpTcpConnector {
    ...
    fn call(&mut self, endpoint: Uri) -> Self::Future {
        ...
        let fut = async move {
            ...
            // Enable .onion connections via StreamPrefs.
            // By default arti rejects .onion addresses (connect_to_onion_services = Auto = off).
            // Set it explicitly to true so hidden-service lightwalletd endpoints work.
            #[cfg(feature = "onion-service-client")]
            let mut prefs = StreamPrefs::new();
            #[cfg(feature = "onion-service-client")]
            prefs.connect_to_onion_services(BoolOrAuto::Val(true));
