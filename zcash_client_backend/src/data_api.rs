...
#[cfg(feature = "transparent-inputs")]
impl TransactionsInvolvingAddress {
    pub fn address(&self) -> TransparentAddress {
        self.address
    }

    pub fn block_range_start(&self) -> BlockHeight {
        self.block_range_start
    }

    pub fn block_range_end(&self) -> Option<BlockHeight> {
        self.block_range_end
    }

    pub fn request_at(&self) -> Option<SystemTime> {
        self.request_at
    }

    pub fn tx_status_filter(&self) -> &TransactionStatusFilter {
        &self.tx_status_filter
    }

    pub fn output_status_filter(&self) -> &OutputStatusFilter {
        &self.output_status_filter
    }
}
...
pub enum TransactionDataRequest {
    ...
    /// the caller should instead invode `WalletWrite::set_request_processed
    ///
