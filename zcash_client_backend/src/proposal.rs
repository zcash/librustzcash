...
pub enum ProposalError {
    ...
    #[cfg(feature = "transparent-inputs")]
    PaysTexFromShielded,
    /// A proposal step would would result in an invalid transaction due to limits on size,
    /// number of inputs, or number of outputs.
    TooLarge(String),
    ...
    /// The proposal tried to pay to a TEX address when the "transparent-inputs" feature
    /// is disabled.
    PaysUnsupportedTexRecipient,
}
...
impl Display for ProposalError {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            ProposalError::TooLarge(s) => write!(
                f,
                r#"A proposal step would result in an invalid transaction due to limits on size, \
                   number of inputs, or number of outputs: {}"#,
                s,
            ),
            ...
            #[cfg(not(feature = "transparent-inputs"))]
            ProposalError::PaysUnsupportedTexRecipient => write!(
                f,
                r#"A proposal tried to pay to a TEX address recipient, which is not supported \
                   because the "transparent-inputs" feature is not enabled."#,
            ),
            ...
            #[cfg(feature = "transparent-inputs")]
            ProposalError::PaysUnsupportedTexRecipient =>
                unreachable!("PaysUnsupportedTexRecipient but it should be supported"),
        }
    }
}
