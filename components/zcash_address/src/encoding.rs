...
mod tests {
    ...
    fn unified() {
        encoding(
            ...
            ZcashAddress {
                net: NetworkType::Main,
                kind: AddressKind::Unified(unified::Address { revision: zcash_protocol::address::Revision::R0, items: vec![unified::Uitem::Data(unified::address::Receiver::Sapling([0; 43]))] }),
            },
        );
        encoding(
