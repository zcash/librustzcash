...
///
/// The minimum of 38 bytes supports the encoding of a transparent-only
/// Revision 1 Unified Viewing Key (1-byte typecode + 1-byte length +
/// 20-byte data + 16-byte padding = 38 bytes) as specified in ZIP 316.
